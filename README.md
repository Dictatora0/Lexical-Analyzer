...
### 1. test_v3_scientific.mini - 科学计数法测试

测试科学计数法数字的识别，如 `1.2e-5`、`3.0E+10`、`6.022e23`。

### 2. test_v3_operators.mini - 逻辑运算符与自增自减测试

测试逻辑运算符 (`&&`, `||`) 和自增自减运算符 (`++`, `--`) 的组合使用。

### 3. test_v3_comprehensive.mini - 综合功能测试（科学计数法 + 逻辑运算符 + 自增自减 + Tab 处理）

测试上述高级特性的综合使用，包括科学计数法、复杂运算符和 Tab 列号计算。

### 4. test_float.mini - 浮点数测试

测试浮点数常量的识别，如 `3.14159`、`0.001`、`999.999`。

### 5. test_string.mini - 字符串测试

测试字符串常量和转义字符，如 `"Hello\n"`、`"C:\\path"`。

### 6. test_features.mini - 综合功能测试（浮点数 + 字符串 + 注释）

测试扩展特性：浮点数、字符串、单行注释、块注释。
...
Lexical-Analyzer/
├── src/                      # 源代码目录
│   └── lexical_analyzer.py   # 词法分析器主程序（约 520 行，包含扩展特性）
├── tests/                    # 测试用例目录
│   ├── test_v3_scientific.mini    # 科学计数法测试
│   ├── test_float.mini       # 浮点数测试
│   ├── test_string.mini      # 字符串测试
│   ├── test_features.mini    # 综合功能测试（浮点数/字符串/注释）
...
│   ├── 项目概览.md                       # 项目结构与快速上手概览
│   ├── 实验报告.md                       # 完整实验报告总览
│   ├── 实验报告_第五部分_测试计划.md     # 测试计划与结果报告
│   ├── 测试用例设计.md                   # 测试用例与覆盖率设计
│   ├── 改进说明_v2.md                    # 基础扩展特性改进说明（浮点数/字符串/注释等）
│   ├── 改进说明_v3.md                    # 高级特性改进说明（科学计数法/逻辑运算符等）
│   ├── 版本对比_v1_v2_v3.md              # 各阶段实现对比（历史文档）
│   ├── v3.0_升级指南.md                  # 从旧版本迁移到当前实现的升级说明（历史文档）
│   └── v3.0_完成报告.md                  # 项目完成报告（历史文档）
