...
v2.0 已经实现了现代词法分析器的基础功能，但在专业场景下还存在一些不足：
...
**文件**: `tests/test_v3_operators.mini`
...
**文件**: `tests/test_v3_comprehensive.mini`
...
v3.0 的双字符运算符处理体现了**最长匹配 (Maximal Munch)** 原则：
